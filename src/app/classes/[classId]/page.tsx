    ...
    return classData && (
        <div>
            ...
            <div  className="block mt-4 mb-1 h-96 p-8">
                ...
                <span className='block pt-4 text-xl italic font-semibold'>Danh sách môn học:</span>
                        ...
                        <div
                           ...
                           <div className='p-2  space-x-2'>
                            ...
                            <div className='flex font-semibold hover:cursor-pointer'>
                                <button className='p-2 flex-1 border-e  bg-blue-500 text-white space-x-2'> Thêm lớp cùng ngành</button>
